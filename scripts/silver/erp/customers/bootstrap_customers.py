#chạy 1 lần duy nhất snap toàn bộ bronze customers và create iceberg
...
def bootstrap_crm_customers():
    ...
    try:
        ...
        spark = create_spark_session("silver_bootstrap_customers")
        
        path = f"""
        s3a://bronze/snapshot/erp/customers/load_date=*/data/
        """.strip()
        ...
        (
            df.writeTo("lakehouse.erp.customers")
            .using("iceberg")
