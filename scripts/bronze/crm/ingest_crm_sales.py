...
def bronze_ingest_crm_sales():
    try:
        pipeline_name = "crm_sales"
        ...
        base_path = f"""
                s3a://bronze/cdc/crm/sales/load_date={load_date}
            """.strip()
        spark, df =  change_ingest_crm(old_watermark=old_watermark, batch_end=batch_end, table_name='sales_details',col_name='sls_ord_num') 
        ...
        print(f"Bronze file sales created")
