...
def bronze_ingest_erp_categories():
    try:
        
        
        pipeline_name = "erp_categories"
        ...
        base_path = f"""
                s3a://bronze/cdc/erp/categories/load_date={load_date}
            """.strip()
        spark, df =  change_ingest_erp(old_watermark=old_watermark, batch_end=batch_end, table_name='px_cat_g1v2',col_name='id') 
