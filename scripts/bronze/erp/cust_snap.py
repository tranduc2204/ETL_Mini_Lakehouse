...
def customers_snapshot():
    spark = None
    try: 
        logger = get_logger("bronze.erp_customer_snapshot")
        logger.info("Starting ERP customer snapshot job")
        ...
        base_path = f"""
            s3a://bronze/snapshot/erp/customers/load_date={load_date}
